...
async function handleStreamingResponse(message: string, history: any[], res: express.Response) {
...
// Stream run response
async function streamRunResponse(threadId: string, runId: string, res: express.Response, encoder: TextEncoder) {
...
async function streamMessages(threadId: string, res: express.Response, encoder: TextEncoder) {
    try {
...
app.post('/api/philaguide', async (req: express.Request, res: express.Response) => {
    try {
...
app.post('/api/search-by-image', upload.single('image'), async (req: express.Request, res: express.Response) => {
    try {
        if (!req.file) {
